...
def banner():
    """Exibe o banner principal com arte ASCII colorida."""
    # Códigos de escape ANSI para a cor magenta
    magenta = "\033[1;95m"
    reset = "\033[0m"
    
    print("")
    print("")
    print(f"                {magenta}________  ___        ___  ________  ________   ___       ___  _____{reset}")
    print(f"               {magenta}|\\   __  \\|\\  \\      |\\  \\|\\   __  \\|\\   ___  \\|\\  \\     /  /|/ __  \\{reset}")
    print(f"               {magenta}\\ \\  \\|\\  \\ \\  \\     \\ \\  \\ \\  \\|\\  \\ \\  \\\\ \\  \\ \\  \\   /  / /\\/_|\\  \\{reset}")
    print(f"                {magenta}\\ \\   __  \\ \\  \\     \\ \\  \\ \\   _  _\\ \\  \\\\ \\  \\ \\  \\ /  / /|/ \\ \\  \\{reset}")
    print(f"                 {magenta}\\ \\  \\ \\  \\ \\  \\____ \\ \\  \\ \\  \\\\  \\\\ \\  \\\\ \\  \\ \\   / /  /    \\ \\  \\{reset}")
    print(f"                  {magenta}\\ \\__\\ \\__\\ \\_______\\ \\__\\ \\__\\\\ _\\\\ \\__\\\\ \\__\\ \\__/ /          \\ \\__\\{reset}")
    print(f"                   {magenta}\\|__|\\|__\\|_______|\\|__|\\|__|\\|__|\\|__| \\|__|\\|__|/            \\|__|{reset}")
    print("")
    print("                      ")
...
def menu():
    ...
    print("\n" * 6)
    print(f"                                   {magenta}║{cyan} Developed by prxd® 2024 {magenta}║{cyan} Updated 11th of September {magenta}║{reset}")
    print("")
...
COMMANDS = {
    "1": lambda: run_powershell_command("Checkpoint-Computer -Description 'Alion Restore Point' -RestorePointType 'MODIFY_SETTINGS'"),
    ...
    "11": lambda: webbrowser.open("https://github.com/joaodrmmd/AlionV1")
}
